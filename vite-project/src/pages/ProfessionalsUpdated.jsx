...
const SelectProfessional = () => {
    ...
    const fetchProfessionals = async () => {
      ...
      try {
        ...
        if (response.success) {
          ...
          if (response.results > 0 && response.data.professionals && response.data.professionals.length > 0) {
            ...
            console.log('No professionals found in API response, showing fallback data');
  ...
  const handleProfessionalSelect = (professional) => {
    ...
    console.log('Updated bookingFlow.selectedProfessionals:', bookingFlow.selectedProfessionals);
  };
    ...
    <div className="select-professional-container">
      ...
      <div className="professional-grid">
        {professionals.map((pro) => (
          <div
            key={pro.id}
            className={`professional-card ${selectedId === pro.id ? 'selected' : ''}`}
