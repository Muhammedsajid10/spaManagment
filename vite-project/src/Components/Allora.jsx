...
//                     <h3 className='allora-h1'>Allora Spa and Massage Center Dubai</h3>
//                     <div className="rating">
//                         <h4 className='all-h4'>
//                             5.0 <FaStar /><FaStar /><FaStar /><FaStar /><FaStar /> (24)
//                         </h4>
//                         <h5 className='allora-h2'>Concord Tower, 1913, 19th Floor, Al Sufouh</h5>
//                     </div>
//                 </div>
//             </div>

//             <div className="swedish-price">
//                 <h3 className='allora-h3'>Swedish Massage</h3>
//                 <h3 className='aed410'>AED 410</h3>
//             </div>

//             <h3 className='icha-1'>1 hr with <a href="#">Icha</a></h3>
//             <div className='divider-line'></div>

//             <div className="final-price">
//                 <div className="total"><b>Total</b></div>
//                 <div className="total-amount">AED 410</div>
//             </div>

//             <button className='btn-allora'>Continue</button>
//         </div>
//     );
// };
